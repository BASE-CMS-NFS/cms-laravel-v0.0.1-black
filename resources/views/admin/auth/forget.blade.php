          ...
          <div class="content-wrapper full-page-wrapper d-flex align-items-center auth login-bg">
            ...
            <div class="card col-lg-4 mx-auto">
              ...
              @endif
                ...
                <h3 class="card-title text-left mb-3">Foroget Password <a href="{{url('/')}}" style="color: orangered">{{Nfs::app()}}</a></h3>
                <form method="POST" action="{{url('forget-password')}}">
                  ...
                  <p class="sign-up">Do you want to login ?<a href="{{url('login')}}"> Sign In</a></p>
                </form>
              </div>
            </div>
          </div>
