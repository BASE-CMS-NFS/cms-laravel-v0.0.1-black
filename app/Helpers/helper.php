...
class Helper {
    ...
    public static function formatPhone($nomorhp) {
       ...
       // bersihkan dari format yang ada titik seperti 0811.222.333.4
        ...
        if(!preg_match('/[^+0-9]/',trim($nomorhp))){
           ...
           elseif(substr($nomorhp, 0, 1)=='0'){
            ...
            // cek apakah no hp karakter 3 adalah 0
    ...
    public static function unFormatPhone($nomorhp) {
        //Terlebih dahulu kita trim dl
        $nomorhp = trim($nomorhp);
       //bersihkan dari karakter yang tidak perlu
        $nomorhp = strip_tags($nomorhp);     
    ...
    public static function status($status){
        if($status == 'true'){
            return '<span class="badge bg-label-success me-1">'.$status.'</span>';
        }elseif($status == 'false'){
            ...
            return '<span class="badge bg-label-info me-1">'.$status.'</span>';
        }elseif($status == 'suspend'){
            return '<span class="badge bg-label-danger me-1">'.$status.'</span>';
        }elseif($status == 'waiting'){
            return '<span class="badge bg-label-warning me-1">'.$status.'</span>';
    ...
    public static function statusPembayaran($status){
        if($status == 'PENDING'){
            ...
            return '<span class="badge bg-label-primary me-1">'.$status.'</span>';
        }   
    }
